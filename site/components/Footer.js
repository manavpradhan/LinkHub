...
const Footer = () => {
  return (
    <footer
      ...
      className="fixed bottom-3 left-[50%] -translate-x-20 invisible md:visible"
    >
      <Link href="/" target="_blank" className="flex items-center gap-2 ">
        ...
        />
        <h5 className="text-indigo-500 font-semibold hover:text-indigo-600 transition-all duration-400 flex items-center">
          Try LinkHub &rarr;
        </h5>
      </Link>
    </footer>
